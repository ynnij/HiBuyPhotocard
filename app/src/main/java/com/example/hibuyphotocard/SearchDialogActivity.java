...
public class SearchDialogActivity extends Activity {
            ...
            public void onClick(View v) {
                ...
                SellItemList.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(itemList.isEmpty()){
                            Intent intent = new Intent(searchDialog.getContext(), MainActivity.class);
    ...
    private void createTextView(String text, LinearLayout layout, String type){
        ...
        GradientDrawable label_drawable = (GradientDrawable) ContextCompat.getDrawable(searchDialog.getContext(),R.drawable.custom_label1);
        ...
        label.setBackground(activityContext.getResources().getDrawable(R.drawable.custom_label1));
