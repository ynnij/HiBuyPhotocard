...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new Fragment1.ChatRecyclerViewAdapter());
    ...
    class ChatRecyclerViewAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new Fragment1.ChatRecyclerViewAdapter.CustomViewHolder(view);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            final Fragment1.ChatRecyclerViewAdapter.CustomViewHolder customViewHolder = (Fragment1.ChatRecyclerViewAdapter.CustomViewHolder)holder;
